        ...
        <div class="px-6 md:px-0 w-full md:w-auto md:flex md:items-center">
          ...
          <ul class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 w-full md:w-auto">
            ...
            <li class="dropdown-container w-full md:w-auto relative">
              <button id="projectsToggle" class="dropdown-toggle group flex items-center justify-between w-full md:w-auto py-2.5 px-3 md:px-4 rounded-lg hover:bg-yellow-50 md:hover:bg-transparent transition-all duration-200">
                <span class="relative font-medium text-black md:text-black group-hover:text-yellow-600 transition-colors duration-200">
                  Projects
                  <span class="md:absolute md:bottom-0 md:left-0 md:w-0 md:h-0.5 md:bg-yellow-500 md:group-hover:w-full md:transition-all md:duration-300"></span>
                </span>
