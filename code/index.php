...
<head>
  ...
  @media (max-width: 768px) {
    .hamburger {
        display: block !important; /* Siguraduhing visible sa mobile */
    }
    
    nav {
        display: none; /* Hide regular nav sa mobile */
    }
...
<body>
  ...
  <header>
    <div class="logo-container">
      <img src="./images/logo.png" class="logo-black" height="30">
      <img src="./images/logo-white.png" class="logo-white" height="30">
    </div>
    ...
    <nav id="nav-menu">
      ...
      <a href="../code/about/about.php">ABOUT</a>
      <a href="./process/services.php">SERVICES</a>
      <div class="dropdown">
        <a href="./projects/all-projects.php">PROJECTS ▾</a>
        <div class="dropdown-content">
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<a href='./projects/project-template-example.php?id=$projectId'>$projectTitle</a>";
            }
          } else {
      ...
      <a href="../code/news/news.php">WHAT'S NEW</a>
      <a href="../code/contact/contact.php">CONTACT</a>
    ...
    <div class="box">
      ...
      <div class="group">
        <div class="CB animate-up delay-1">
          ...
          <a href="../code/cabinet/cabinet.php" class="get-now-btn">GET NOW</a>
        </div>
