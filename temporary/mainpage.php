...
<body class="text-gray-800 leading-relaxed">
  ...
  <section class="relative w-full h-screen overflow-hidden font-sans">
    ...
    <div class="relative z-20 flex flex-col items-start justify-center h-full text-right px-6 md:px-12 lg:px-20">
      <!-- Logo Container -->
      <div class="w-full max-w-2xl py-4">
        <img src="../logo/mmone.png" alt="MMOne" class="w-48 md:w-60 lg:w-72 mr-auto transform transition-transform duration-500 hover:scale-105">
      </div>
