...
<body class=" min-h-screen bg-white">
  ...
  <div class=" px-6 pb-12">
    <div id="products-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
      ...
      ?>
          <div class=" product-card rounded-lg shadow-lg hover:shadow-xl overflow-hidden" 
            ...
            <div class="relative group">
              ...
              <?php else: ?>
                <div class="w-full h-48 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <i class="fas fa-image text-4xl text-orange-900"></i>
                </div>
              <?php endif; ?>

              <!-- Status Badge -->
              <div class="absolute top-2 right-2">
                <span class="text-xs px-2 py-1 rounded font-medium <?php
                                                                        switch ($row['status'] ?? '') {
                                                                          case 'Active':
              ...
              <?php if ($row['type_count'] > 0): ?>
                <div class="absolute top-2 left-2">
                  <span class="bg-orange-900 text-white text-xs px-2 py-1 rounded font-medium">
              ...
              <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                <a href="cabinet/get_products.php?id=<?= $row['product_id'] ?? 0 ?>"
                  class="opacity-0 group-hover:opacity-100 text-indigo-600 px-4 py-2 rounded-lg font-medium transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
