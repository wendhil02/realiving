...
<body class="bg-gray-200">
    <section>
        <main class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="flex items-center justify-center bg-gray-200">
                <div class="flex flex-col md:flex-row items-center justify-center w-full max-w-8xl space-y-8 md:space-y-0 md:space-x-8 p-1">
                    <!-- Container with Background Image and Overlay -->
                    <div class="relative flex w-full md:w-[1600px] h-[500px] items-center justify-center overflow-hidden bg-cover bg-center" id="bg-slide-container">
                        <!-- Background Image will be dynamically added via JS -->
                        <!-- Overlay -->
                        <div class="absolute inset-0 bg-gray-700 bg-opacity-30 backdrop-blur-sm"></div>

                        <!-- Slide Content (Centered text with transition) -->
                        <div id="slide-container" class="absolute inset-0 flex flex-col items-center justify-center text-center px-10 transition-opacity duration-1000 opacity-100">
                            <h1 class="text-white text-6xl font-bold mb-6" id="title-text">Your Title Here</h1>
                            <p class="text-white text-xl" id="subtitle-text">Your subtitle or description here.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mb-4 flex items-center">
        <label for="sortOrder" class="mr-2 text-gray-700">Sort by:</label>
        <select id="sortOrder" class="px-4 py-2 border rounded-md">
