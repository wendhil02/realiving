            ...
            <div class="flex flex-col md:flex-row justify-between items-start mb-8">
                ...
                <div class="mb-6 md:mb-0 md:w-1/3">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            <ul class="space-y-2">
                                <li><a href="index" class="text-sm hover:text-[#f59e0b] transition-colors duration-200">Home</a></li>
                        ...
                        <div>
                            <ul class="space-y-2">
                                <li><a href="appointment" class="text-sm hover:text-[#f59e0b] transition-colors duration-200">Appointment</a></li>
                                <li><a href="contact" class="text-sm hover:text-[#f59e0b] transition-colors duration-200">Contact & FAQ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
